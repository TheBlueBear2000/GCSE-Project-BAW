...
class Tree(util.collidable):
    def __init__(self,x,y,surface):
        self.images = [pygame.transform.scale(pygame.image.load(dir + "assets/objects/squares/tree_stump.png"),(240,240)),pygame.transform.scale(pygame.image.load(dir + "assets/objects/squares/tree_top.png"),(240,240))]
