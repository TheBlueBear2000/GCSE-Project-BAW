...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, actions, tiles, force = False):
        ...
        if self.animation_tick > self.animation_speed or force == True:
            self.animation_tick = 0

            

#            for tile in tiles:
#                if (data.getScreenSize()[0] - (self.rect.width/2) < tile.rect.center[0] < data.getScreenSize()[0] + (self.rect.width/2)
#                and data.getScreenSize()[1] - (self.rect.height/2) < tile.rect.center[1] < data.getScreenSize()[1] + (self.rect.height/2)):
