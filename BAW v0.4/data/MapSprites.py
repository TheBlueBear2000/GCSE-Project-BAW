...
class Raft(pygame.sprite.Sprite):
    def __init__(self,x,y,surface):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(pygame.image.load("assets/objects/squares/items/raft.png"),(160,120))
        self.rect = self.image.get_rect()
        self.rect.x,self.rect.y = x,y
        self.rect.center = (self.rect.x,self.rect.y)
        self.xCoord,self.yCoord = self.rect.x + 40, self.rect.y + 40
    ...
    def update(self,actions,player):
        if actions["action2"]:
            ...
            or ((self.rect.x + self.rect.width > 1500/2 - 120 and self.rect.x + self.rect.width < 1500/2 + 120) and (self.rect.y + self.rect.height > 1000/2 - 80 and self.rect.y + self.rect.height < 1000/2 + 80))): # Check bottom right corner for collision
                ...
                player.invEdit(self.itemID, 0)
                player.addScore(random.randint(45,55))
                self.kill()
...
class Bone(pygame.sprite.Sprite):
    def __init__(self,x,y,surface):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(pygame.image.load("assets/objects/squares/items/bone.png"),(80,80))
        self.rect = self.image.get_rect()
        self.rect.x,self.rect.y = x,y
        self.rect.center = (self.rect.x,self.rect.y)
        self.xCoord,self.yCoord = self.rect.x + 40, self.rect.y + 40
    ...
    def update(self,actions,player):
        if actions["action2"]:
            ...
            or ((self.rect.x + self.rect.width > 1500/2 - 120 and self.rect.x + self.rect.width < 1500/2 + 120) and (self.rect.y + self.rect.height > 1000/2 - 80 and self.rect.y + self.rect.height < 1000/2 + 80))): # Check bottom right corner for collision
                ...
                # If they are, add the item to the players inventory and kill sprite
                player.invEdit(self.itemID, 0)
                player.addScore(random.randint(15,25))
                self.kill()
...
class TennisBall(pygame.sprite.Sprite):
    def __init__(self,x,y,surface):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(pygame.image.load("assets/objects/squares/items/tennis_ball.png"),(80,80))
        self.rect = self.image.get_rect()
        self.rect.x,self.rect.y = x,y
        self.rect.center = (self.rect.x,self.rect.y)
        self.xCoord,self.yCoord = self.rect.x + 40, self.rect.y + 40
        print("new Tenis Ball tile has following data: " + str(self.rect.center))
        surface.blit(self.image, (self.rect.x,self.rect.y))

        self.itemID = "tennis_ball"
...
class Chest(pygame.sprite.Sprite):
    def __init__(self,x,y,surface):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(pygame.image.load("assets/objects/squares/items/chest.png"),(80,80))
        self.rect = self.image.get_rect()
        self.rect.x,self.rect.y = x,y
        self.rect.center = (self.rect.x,self.rect.y)
        self.xCoord,self.yCoord = self.rect.x + 40, self.rect.y + 40
    ...
    def update(self,actions,player):
        if actions["action2"]:
            ...
            or ((self.rect.x + self.rect.width > 1500/2 - 120 and self.rect.x + self.rect.width < 1500/2 + 120) and (self.rect.y + self.rect.height > 1000/2 - 80 and self.rect.y + self.rect.height < 1000/2 + 80))): # Check bottom right corner for collision
                ...
                # If they are, add the item to the players inventory and kill sprite
                player.invEdit(self.itemID, 0)
                player.addScore(random.randint(25,35))
                self.kill()
