...
class saveGame(pygame.sprite.Sprite):
    def __init__(self,number):
        ...
        self.images = [pygame.transform.scale(pygame.image.load("assets/gui/savegame_card.png"),(600,450)),
                        pygame.transform.scale(pygame.image.load("assets/gui/savegame_play.png"),(600,450)),
                        pygame.transform.scale(pygame.image.load("assets/gui/savegame_editname.png"),(600,450)),
                        pygame.transform.scale(pygame.image.load("assets/gui/savegame_wipehover.png"),(600,450))]
        ...
        self.normalFont = pygame.font.Font("assets/gui/fonts/normal.ttf", 22)
        self.largeFont = pygame.font.Font("assets/gui/fonts/normal.ttf", 100)

        self.text_box = pygame.transform.scale(pygame.image.load("assets/gui/text_box.png"),(1500,1000))
        self.tint = pygame.transform.scale(pygame.image.load("assets/gui/tint.png"),(1500,1000))
    ...
    def getSave(self):
        with open(str("saves/savegame_" + str(self.number) + ".json"),"r") as file:
            obj = json.load(file)
            return obj
    ...
    def save(self,data):
        with open(("saves/savegame_" + str(self.number) + ".json"),"w") as file:
            json.dump(data,file)
